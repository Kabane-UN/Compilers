...
parse_table = {
	...
	(TermInitBase, TokensBaseToken): [TokensBaseToken, IdentBaseToken, CommaSeqBase, DotBaseToken], 
	(AxiomBase, StartBaseToken): [StartBaseToken, IdentBaseToken, DotBaseToken], 
	(RuleBase, IdentBaseToken): [IdentBaseToken, IsBaseToken, IdentSeqBase, DotBaseToken], 
